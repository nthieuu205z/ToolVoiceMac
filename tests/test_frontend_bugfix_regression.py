...
def test_ui_assets_are_cache_busted_after_bugfix():
    ...
    assert 'style.css?v=20260911-voice-projects3' in html
    assert 'app.js?v=20260911-voice-projects3' in html
    assert 'omnivoice-settings.js?v=20260911-voice-projects3' in html
